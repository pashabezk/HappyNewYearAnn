// кастомная функция для обработки свайпов
var swipe = function(el, settings) {
	...
	// возвращает объект с доступными событиями
	...
	// принимает в качестве аргумента событие
	// возвращает либо TouchList, либо оставляет событие без изменения
